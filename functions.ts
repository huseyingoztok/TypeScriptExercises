function Sum(item : number , item2 : number) : number {
    return item + item2;
}


function Sum2(item : number, item2 : number) {
    return item + item2;
}
...
//Default parameter
function Sum5(item : number , item2 : number = 4) {
   return item + item2; 
}
...
function Sum6(item : number , item2? : number) {
    return item + item2;
}

console.log(Sum6(4)); //Nan

function Sum7(item : number , item2? : number) {
    if (item2) {
        return item + item2;
    }
    return item;
